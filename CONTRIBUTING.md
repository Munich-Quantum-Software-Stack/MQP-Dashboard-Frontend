...
Using the following [Issue Tracker](https://github.com/Munich-Quantum-Software-Stack/MQSS-Benchmarking-Framework/issues/new?template=contact_mqp_dashboard_frontend.yml) you can:
...
3.  **Expected vs. Actual:** Clearly state what you expected to happen and what actually happened.


## 💻 Code Contribution Workflow

1.  **Fork** the repo and clone your fork.
2.  **Run the app in development mode:** `npm start`. This will take care of installing all necessary dependencies and make the dashboard available at [http://localhost:3000](http://localhost:3000).
3.  **Create a branch:** 
    - when fixing a bug: `git switch -c fix/<BUG>`
    - when introducibng a feature: `git switch -c feat/<FEATURE>`
...
* **Reference Issues:** Add `Closes #XYZ` to the description if it fixes an issue.
