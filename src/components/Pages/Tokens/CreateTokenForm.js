        ...
        <React.Fragment>
            ...
            {!data && (
                <div className="mb-4 tokenForm_container">
                    <p
                        className="form_indication_text"
                        style={{ fontSize: small_fs }}
                    >
                        (*) Required field
                    </p>
                    <form
                            ...
                            <div className="col-12 col-xl-6 ">
                                ...
                                <div className="form-group mb-3 token_input">
                                    ...
                                    <div
                                        ...
                                        style={{ fontSize: text_fs }}
                                    >
                                        <span id="validity_value">
                                            {validity}
                                        </span>
                                        <span>
                                            /{userLimits.max_lifetime} day(s)
                                        </span>
                                    </div>
                                </div>
