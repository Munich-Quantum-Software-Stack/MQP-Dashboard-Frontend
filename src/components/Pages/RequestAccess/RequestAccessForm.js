...
function RequestAccessForm() {
    ...
    const submitRequestAccessHandler = async (event) => {
        ...
        if (
            !isEmailValid || emailHasError || nameHasError ||
            projectHasError ||
        ...
        try {
            ...
            console.log(error);
            setHttpErr(
                "Could not process your data due to an internal server error."
            );
        }
    }
        ...
        <div className="mb-4 request_access_content">
            ...
            {!isSucceed && (
                <>
                    ...
                    <form
                        id="request_form"
                        onSubmit={submitRequestAccessHandler}
                        method="POST"
                    >
                        {validationError && (
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="d-flex justify-content-start request_name_field">
                                    ...
                                    <Form.Group
                                        className="mb-3 name_input_field"
                                        controlId="name"
                                    >
                        ...
                        <div className="row">
                            <div className="my-3 d-flex justify-content-center align-items-center">
                                <Button
                                    type="submit"
                                    className="me-4 request_submit_button"
                                    title="Send"
                                >
